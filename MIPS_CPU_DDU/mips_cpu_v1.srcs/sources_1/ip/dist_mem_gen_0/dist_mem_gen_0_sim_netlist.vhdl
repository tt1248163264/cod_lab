...
--               D:/vivado/lab5/mips_cpu_v1/mips_cpu_v1.srcs/sources_1/ip/dist_mem_gen_0/dist_mem_gen_0_sim_netlist.vhdl
...
ram_reg_0_127_16_16: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"000000000000000000001C88C8899040"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(16),
...
ram_reg_0_127_21_21: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"00000000000000000000115115544040"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(21),
